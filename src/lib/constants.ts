...
export const RECORD_TYPES = {
  meeting: { label: "Reunião", color: "bg-blue-500/10 text-blue-600" },
  decision: { label: "Decisão", color: "bg-purple-500/10 text-purple-600" },
  observation: { label: "Observação", color: "bg-amber-500/10 text-amber-600" },
  risk: { label: "Risco", color: "bg-destructive/10 text-destructive" },
  communication: { label: "Comunicação", color: "bg-emerald-500/10 text-emerald-600" },
} as const;
