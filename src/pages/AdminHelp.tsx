...
const helpSections: HelpSection[] = [
  ...
  },
  {
    ...
    category: "Fundamentos",
    content: [
      "O Dashboard Administrativo é seu painel de inteligência da carteira de clientes. Ele NÃO mostra detalhes operacionais como nomes de colaboradores, descrições de ações ou práticas específicas. Esses dados pertencem exclusivamente ao portal de cada empresa.",
      "**Visão Geral da Carteira (8 indicadores):**",
      ...
      "• **Turmas Realizadas** — Total de turmas em todas as empresas",
      "• **Ações Concluídas** — Total agregado de ações concluídas na carteira",
      "• **Ações Atrasadas** — Total agregado de ações em atraso na carteira",
      ...
      "• Alertas são sempre contextualizados por empresa — nunca mostram detalhes operacionais",
      "• Clique em uma empresa para acessar a página de gestão de empresas",
      "**Alertas Estratégicos:**",
      "• Painel lateral mostrando empresas que precisam de atenção imediata",
      "• Cada alerta indica: nome da empresa + tipo de problema (ex: '6 ações atrasadas', 'Cobertura baixa')",
      "• Ao clicar, navega para a página da empresa correspondente",
      "• Nenhum alerta mostra nomes de colaboradores, práticas ou ações individuais",
      "**Distribuição por Ciclo:**",
      "• Gráfico de barras mostrando quantas empresas estão em cada ciclo (M1 a P3)",
      "• Cores: azul (Monitorar), amarelo (Validar) e verde (Perpetuar)",
      ...
      "• Gauge com a média da carteira + barras individuais por empresa",
      "**Empresas com Ações Atrasadas:**",
      "• Ranking das empresas com mais atrasos (sem listar ações individuais)",
      "**Velocímetro de Maturidade:**",
      "• Índice médio de maturidade da carteira MVP como gauge visual",
      "**Como agir diante dos indicadores:**",
      "• 🔴 Risco: Entre em contato imediato com a empresa, revise prazos e acompanhamento",
      "• 🟡 Atenção: Sugira criação de turmas, revisão do plano ou acompanhamento mais próximo",
      "• 🟢 Saudável: Incentive o avanço para o próximo ciclo e reconheça o progresso",
