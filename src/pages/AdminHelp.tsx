...
const helpSections: HelpSection[] = [
  ...
  },
  {
    ...
    category: "Fundamentos",
    content: [
      "O Dashboard Administrativo é seu painel de gestão estratégica da carteira de clientes. Ele consolida dados de todas as empresas em uma única visão.",
      ...
      "• Gráfico de rosca mostrando quantas empresas estão em cada faixa: Inicial (0-25%), Estruturando (26-50%), Evoluindo (51-75%), Consolidando (76-100%)",
      "**Cobertura de Treinamento:**",
      "• Mostra a média de cobertura da carteira e barras individuais por empresa",
      "• Cobertura = colaboradores treinados ÷ base populacional",
      "**Ações Críticas:**",
      "• Lista as empresas com mais ações atrasadas para intervenção prioritária",
      "**Como agir diante dos indicadores:**",
      "• 🔴 Risco: Entre em contato com a empresa, revise prazos e responsáveis das ações atrasadas",
      "• 🟡 Atenção: Monitore de perto, sugira criação de turmas ou revisão do plano de ação",
      "• 🟢 Saudável: Acompanhe a evolução e incentive o avanço para o próximo ciclo",
      "**Alertas Inteligentes:**",
      "• Os alertas do painel são contextualizados com empresa, ciclo e tipo de problema",
      "• Clique em qualquer alerta para navegar diretamente ao item relacionado",
      "• Alertas críticos (🔴) devem ser tratados com prioridade",
    ],
  },
  {
    id: "companies",
